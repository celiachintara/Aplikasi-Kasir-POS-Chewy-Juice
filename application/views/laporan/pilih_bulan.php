  <div class="content-wrapper" style="margin-bottom: 20px">
    <div class="container">
      <div class="row pad-botm">
          <div class="col-md-12">
              <h4 class="header-line">LAPORAN REKAPITULASI PENJUALAN</h4>
          </div>
      </div>
      <div class="row">
        <div class="col-md-12">
            <form class="form-inline" target="_blank" action="<?php echo base_url('laporan/rekapitulasi-penjualan/') ?>" method="post">
