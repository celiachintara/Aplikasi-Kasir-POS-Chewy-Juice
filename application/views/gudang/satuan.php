...
<div class="formSidebar w3-bar-block" style="right:0;padding:10px;" id="rightMenu">
  <button id="judul" onclick="tutupSideForm()" class="w3-bar-item">&times; Close Sidebar</button>
      <form id="formTambah" action="<?php echo base_url('gudang/simpan_satuan') ?>" method="post">
        <table border="0" class="table" align="center">
          <tr>
            <td>Kode Satuan</td>
            <td>:</td>
            <td ><input name="kd_satuan" type="text" id="kd_satuan" /></td>
          </tr>
          <tr>
            <td>Nama Satuan</td>
            <td>:</td>
        ...
        <div class="w3-teal">
          <button id="bukaSide" class="w3-button w3-teal w3-right" onclick="openRightMenu()">&#9776;</button>
            <div class="w3-container">
              <h3>SATUAN BAHAN <span class="pull-right"><a href="">Tambah Data</a></span></h3>
            </div>
        </div>
                ...
                <table id="tbKategori" class="table table-bordered table-striped table-responsive">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td style="text-align: center;"><a href="javascript:void(0);" class="edit_record" data-kode="<?php echo $key->kd_satuan ?>" data-nama="<?php echo $key->nm_satuan ?>">Edit</a></td>
                    </tr>
                    <?php endforeach?>
                  </tbody>
                </table>
    ...
    <section class="footer-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                &copy; Copyright <?php echo date('Y') ?>, <a href="https://ciaws-cntr.blogspot.com" target="_blank">Celia Chintara Yuwine</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <script>
      ...
      $( document ).ready(function() {
          ...
          $('#tbKategori').on('click','.edit_record',function(){
              ...
              $('#formTambah').attr('action', '<?php echo base_url('gudang/simpan_satuan_edit') ?>');
