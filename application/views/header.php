        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="<?php echo base_url('dashboard/') ?>">
                    <img height="130px" src="<?php echo base_url() ?>/assets/img/logo.png" />
                </a>
                <h2 style="display: inline; text-transform: uppercase;font-family: Papyrus,fantasy; margin-left: 10px; "><?php echo $namatoko ?></h2>
            </div>
        </div>
    </div>
<?php
                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-left">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="<?php echo base_url('gudang/pembelian-start/') ?>">PEMBELIAN BAHAN</a></li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" target="_blank" href="<?php echo base_url('laporan/pembelian/') ?>">PEMBELIAN BAHAN</a></li>
